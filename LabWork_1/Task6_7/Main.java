...
public class Main {
   public static void main(String[] args) {
      ...
      Bank bank2 = new Bank("bankofamerica");

      User nazar = new User("Nazar");
      User sofia = new User("Sofia");

      BankAccount nazarAccountUAH = new BankAccount("UAH_1", nazar, bank1, "UAH", 15000);
      BankAccount nazarAccountUSD = new BankAccount("USD_2", nazar, bank2, "USD", 500);
      BankAccount sofiaAccountUAH = new BankAccount("UAH_3", sofia, bank1, "UAH", 17000);
